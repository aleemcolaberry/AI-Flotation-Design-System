...
function AflLogos({ b, swap }) {
  ...
  const src = b.mark;
  const mk = (size, color) => aflMask(src, size, color);
  ...
  const files = ['assets/ai-flotation-mark.svg', 'assets/ai-flotation-mark-current.svg', 'assets/ai-flotation-mark-white.svg'];
  ...
  React.createElement("span", { style: { fontSize: '10.5px', fontWeight: 700, padding: '4px 10px', borderRadius: '999px', flexShrink: 0, background: '#FCF1DD', color: '#8A5A00' } }, "New mark proposed this round"), /*#__PURE__*/
  React.createElement("span", { style: { fontSize: '12.5px', color: '#5C6470', maxWidth: '640px' } }, "A float held clear of the waterline \u2014 systems that keep work moving. One path, reads at 16px.")
  ), /*#__PURE__*/
  ...
  React.createElement("div", { style: tile }, /*#__PURE__*/React.createElement("div", { style: tileTitle }, "Mark"), /*#__PURE__*/React.createElement("div", { style: stage }, /*#__PURE__*/React.createElement("span", { style: mk(72, L.accent) })), /*#__PURE__*/React.createElement("div", { style: tileMeta }, src, " \xB7 min 16px")), /*#__PURE__*/
  React.createElement("div", { style: tile }, /*#__PURE__*/React.createElement("div", { style: tileTitle }, "Horizontal lockup"), /*#__PURE__*/React.createElement("div", { style: stage }, /*#__PURE__*/React.createElement("span", { style: { display: 'inline-flex', alignItems: 'center', gap: '14px' } }, /*#__PURE__*/React.createElement("span", { style: mk(44, L.accent) }), /*#__PURE__*/React.createElement("span", { style: word(L.fg) }, b.name))), /*#__PURE__*/React.createElement("div", { style: tileMeta }, "Min width 120px \xB7 clearspace \xBD mark height")), /*#__PURE__*/
  React.createElement("div", { style: tile }, /*#__PURE__*/React.createElement("div", { style: tileTitle }, "Vertical lockup"), /*#__PURE__*/React.createElement("div", { style: stage }, /*#__PURE__*/React.createElement("span", { style: { display: 'inline-flex', flexDirection: 'column', alignItems: 'center', gap: '12px' } }, /*#__PURE__*/React.createElement("span", { style: mk(72, L.accent) }), /*#__PURE__*/React.createElement("span", { style: { ...word(L.fg), textAlign: 'center', maxWidth: '210px' } }, b.name))), /*#__PURE__*/React.createElement("div", { style: tileMeta }, "Centered contexts \u2014 badges, splash, certificates")), /*#__PURE__*/
  ...
  [84, 48, 26].map((s) => /*#__PURE__*/React.createElement("span", { key: s, style: { width: s + 'px', height: s + 'px', borderRadius: Math.round(s * 0.22) + 'px', background: L.accent, display: 'inline-flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 } }, /*#__PURE__*/React.createElement("span", { style: mk(Math.round(s * 0.58), L.accentContrast) })))
  ...
  [32, 24, 16].map((s) => /*#__PURE__*/React.createElement("span", { key: s, style: { display: 'inline-flex', flexDirection: 'column', alignItems: 'center', gap: '8px' } }, /*#__PURE__*/React.createElement("span", { style: mk(s, L.accent) }), /*#__PURE__*/React.createElement("span", { style: { fontSize: '10.5px', color: '#8A919B', fontFamily: 'ui-monospace, monospace' } }, s, "px")))
  )), /*#__PURE__*/React.createElement("div", { style: tileMeta }, "Same SVG, token-colored \u2014 still reads at 16px")), /*#__PURE__*/
  React.createElement("div", { style: tile }, /*#__PURE__*/React.createElement("div", { style: tileTitle }, "On dark"), /*#__PURE__*/React.createElement("div", { style: { ...stageBase, background: D.bg, border: '1px solid ' + D.line, flex: 1 } }, /*#__PURE__*/React.createElement("span", { style: { display: 'inline-flex', alignItems: 'center', gap: '14px' } }, /*#__PURE__*/React.createElement("span", { style: mk(44, D.accent) }), /*#__PURE__*/React.createElement("span", { style: word(D.fg) }, b.name))), /*#__PURE__*/React.createElement("div", { style: tileMeta }, 'Dark-mode accent ' + D.accent.toUpperCase() + ' on ' + D.bg.toUpperCase())), /*#__PURE__*/
  React.createElement("div", { style: tile }, /*#__PURE__*/React.createElement("div", { style: tileTitle }, "Monochrome"), /*#__PURE__*/React.createElement("div", { style: stage }, /*#__PURE__*/React.createElement("span", { style: { display: 'inline-flex', alignItems: 'center', gap: '14px' } }, /*#__PURE__*/React.createElement("span", { style: mk(44, L.fg) }), /*#__PURE__*/React.createElement("span", { style: word(L.fg) }, b.name))), /*#__PURE__*/React.createElement("div", { style: tileMeta }, "Single-color contexts \u2014 print, stamp, embossing")), /*#__PURE__*/
  ...
  React.createElement("div", null, "Colors come from tokens only \u2014 accent on bg, fg for mono, accentContrast on accent tiles. Never stretch, rotate or add effects."), /*#__PURE__*/
...
function AflLoginPanel({ b, mode, swap }) {
  ...
  React.createElement("span", { style: { display: 'inline-flex', alignItems: 'center', gap: '10px' } }, /*#__PURE__*/React.createElement("span", { style: aflMask(b.mark, 26, m.accent) }), /*#__PURE__*/React.createElement("span", { style: { fontFamily: heading, fontWeight: 700, fontSize: '19px', color: m.fg } }, b.name))
  ), /*#__PURE__*/
