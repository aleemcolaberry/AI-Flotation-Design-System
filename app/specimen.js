...
function AflPanel({ b, mode, demo, setDemo, copied, copyText, swap }) {
  ...
  React.createElement("span", { style: { display: 'inline-flex', alignItems: 'center', gap: '10px' } }, /*#__PURE__*/React.createElement(AflMark, { size: 26, hull: m.fg, float: m.accent }), /*#__PURE__*/React.createElement("span", { style: { fontFamily: heading, fontWeight: hw, fontSize: '17px', color: m.fg } }, b.name)), /*#__PURE__*/
